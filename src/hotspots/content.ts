...
export interface HotspotContent {
  title: string;
  body: string;
  /** Close-up shown at the top of the examine panel — a crop from
   * scene.png for now (see public/examine/), swap for a hand-painted
   * illustration per hotspot later without touching overlay.ts. */
  image: string;
}

const examine = (id: string) => `${import.meta.env.BASE_URL}examine/${id}.jpg`;
